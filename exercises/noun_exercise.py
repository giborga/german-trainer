...
class NounExercise(BaseExercise):
    ...
    def generate_exercise(self):
        ...
        prompt = f"""
You help a student to learn and remember German nouns on levels A1-A2 providing an exercise and a correct answer.
The German noun is: {word}.
Rules for exercise and answer generation:
1. Create ONE A2 exercise focused on: correct noun article or plural form.
